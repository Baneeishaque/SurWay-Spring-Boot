...
public class QuestionController {
	...
	public String addQuestion(@RequestParam(value = "mandatory", required = false) boolean mandatory,
			...
			@RequestParam(value = "questionNumber") int qNum, Model m) {

		// save question

		System.out.println("mandatory: " + mandatory + " Question:" + question + " Type: " + type + " SurveyId: "
				+ surveyId + " optionOne: " + option1 + " optionTwo: " + option2 + " optionThree: " + option3
				+ " option4: " + option4 + " option5: " + option5 + " questionNumber: " + qNum);
...
//			finalOption = option1+","+option2+","+option3+","+option4+","+option5;
	...
	public String loadQuestion(@RequestParam(value = "survey") int surveyId,
			@RequestParam(value = "q") int questionNumber, Model m) {
	...
	public String updateQuestion(@RequestParam("questionId") int questionId,
			...
			@RequestParam(value = "optionFour", required = false) String option4,
			@RequestParam(value = "optionFive", required = false) String option5,
			@RequestParam(value = "dropdownOptions", required = false) String dropdownOption, Model m) {
